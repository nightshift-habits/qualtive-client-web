...
export const present = (collection: string, options?: FormOptions): Form => {
  ...
  titleElement.textContent = options?.title || _("form.title", options?.locale)
  ...
  cancelButtonElement.textContent = _("form.cancel", options?.locale)
  ...
  successTextElement.textContent = _("form.sending", options?.locale)
  ...
  const send = (): void => {
    ...
    post(collection, {
      ...
      .catch((error) => {
        setEnabled(true)
        containerElement.className = containerElement.className.replace("_q-sent", "_q-error")
        successTextElement.textContent = _("form.error", options?.locale)
  ...
  const renderQuestionContent = () => {
        ...
        switch (questionContent.type) {
          ...
          case "score": {
            ...
            const optionElements: HTMLLIElement[] = scores.map((score) => {
              ...
              switch (score) {
                case 0:
                  buttonElement.innerHTML = iconScore0
                  break
                case 25:
                  buttonElement.innerHTML = iconScore25
                  break
                case 50:
                  buttonElement.innerHTML = iconScore50
                  break
                case 75:
                  buttonElement.innerHTML = iconScore75
                  break
                case 100:
                  buttonElement.innerHTML = iconScore100
                  break
              }
    ...
    if (options?.supportURL) {
      ...
      linkElement.textContent = _("form.support", options.locale) + " ->"
