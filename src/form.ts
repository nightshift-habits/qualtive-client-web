...
export const present = (collection: string, options?: FormOptions): Form => {
  ...
  successButtonElement.innerHTML =
    '<svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M1 1L11 11M11 1L1 11L11 1Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>' +
