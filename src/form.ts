          ...
          switch (content.type) {
            ...
            case "attachments": {
              ...
              content.values.forEach((attachment, index) => {
                ...
                imgElement.setAttribute("title", _("form.image.index") + (index + 1))
